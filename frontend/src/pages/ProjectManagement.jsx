            ...
            <div className="modal-body">
              ...
              {editType === 'task' && (
                <>
                      ...
                      <input 
                        ...
                        onChange={e => {
                          ...
                          setEditingItem({
                            ...editingItem,
                            start_time: start,
                            duration_minutes: calculateDuration(start, editingItem.end_time)
                          });
                        }} 
                      />
                    </div>
                      ...
                      <input 
                        ...
                        onChange={e => {
                          ...
                          setEditingItem({
                            ...editingItem,
                            end_time: end,
                            duration_minutes: calculateDuration(editingItem.start_time, end)
                          });
                        }} 
                      />
                    </div>
                  ...
                  <div className="form-group">
                    <label>Date</label>
                    <input type="date" value={editingItem.log_date} onChange={e => setEditingItem({...editingItem, log_date: e.target.value})} />
                  </div>
                </>
              )}
            </div>
